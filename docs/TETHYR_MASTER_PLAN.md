...
North star: _"It's where people build things together and get known for what
they make."_
...
- Phase 7 — Opportunity Layer (browse by need). _Partially live._
- Phase 8 — Dashboard (everything actionable). _Mostly live._
- Phase 9 — Knowledge Layer (projects generate docs/resources).

### Layer C — Collaboration Depth (newest thinking)

Diagnosis: the loop is strong at _discover_ and _build_ but **thin in the
...
2. **Project "need help now"** — lightweight urgent ask. _Being built now_
...
3. For significant UI/product changes, follow `TETHYR_UX_RULES.md` and write
   the reasoning proposal _before_ editing JSX.
