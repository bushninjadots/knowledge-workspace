...
-- ---------------------------------------------------------------------------
INSERT INTO public.challenges (id, title, description, type, skills, difficulty, status, created_by, start_date, end_date, max_participants, pass_criteria)
VALUES
