...
GRANT SELECT ON public.team_projects TO anon;
GRANT SELECT, INSERT, DELETE ON public.team_projects TO authenticated;
...
REVOKE ALL ON FUNCTION public.notify_team_invite() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.notify_team_invite() FROM anon;
REVOKE ALL ON FUNCTION public.notify_team_invite() FROM authenticated;
