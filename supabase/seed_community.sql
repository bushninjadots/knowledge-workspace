...
BEGIN
  ...
  VALUES
    ('00000000-0000-0000-0000-000000000000','90000000-0000-0000-0000-000000000001','authenticated','authenticated', pw,
      ...
      now(), '{"provider":"email","providers":["email"]}', '{"display_name":"Rin Sato","handle":"rin","craft":"Software"}', false, false, false, now(), now()),
    ('00000000-0000-0000-0000-000000000000','90000000-0000-0000-0000-000000000002','authenticated','authenticated', pw,
      now(), NULL, '', NULL, '', NULL, '', '', NULL, '', 0, NULL, NULL, '', '', NULL,
      now(), '{"provider":"email","providers":["email"]}', '{"display_name":"Ana Vasquez","handle":"ana","craft":"Accessibility"}', false, false, false, now(), now()),
    ('00000000-0000-0000-0000-000000000000','90000000-0000-0000-0000-000000000003','authenticated','authenticated', pw,
      now(), NULL, '', NULL, '', NULL, '', '', NULL, '', 0, NULL, NULL, '', '', NULL,
      now(), '{"provider":"email","providers":["email"]}', '{"display_name":"Marcus Webb","handle":"marcus","craft":"Backend"}', false, false, false, now(), now()),
    ('00000000-0000-0000-0000-000000000000','90000000-0000-0000-0000-000000000004','authenticated','authenticated', pw,
      now(), NULL, '', NULL, '', NULL, '', '', NULL, '', 0, NULL, NULL, '', '', NULL,
      now(), '{"provider":"email","providers":["email"]}', '{"display_name":"Misaa Lee","handle":"misaa","craft":"Product"}', false, false, false, now(), now()),
    ('00000000-0000-0000-0000-000000000000','90000000-0000-0000-0000-000000000005','authenticated','authenticated', pw,
      now(), NULL, '', NULL, '', NULL, '', '', NULL, '', 0, NULL, NULL, '', '', NULL,
      now(), '{"provider":"email","providers":["email"]}', '{"display_name":"Ola Adeyemi","handle":"ola","craft":"Community"}', false, false, false, now(), now()),
    ('00000000-0000-0000-0000-000000000000','90000000-0000-0000-0000-000000000006','authenticated','authenticated', pw,
      now(), NULL, '', NULL, '', NULL, '', '', NULL, '', 0, NULL, NULL, '', '', NULL,
      now(), '{"provider":"email","providers":["email"]}', '{"display_name":"Dee Brooks","handle":"dee","craft":"Sound"}', false, false, false, now(), now()),
    ('00000000-0000-0000-0000-000000000000','90000000-0000-0000-0000-000000000007','authenticated','authenticated', pw,
      now(), NULL, '', NULL, '', NULL, '', '', NULL, '', 0, NULL, NULL, '', '', NULL,
      now(), '{"provider":"email","providers":["email"]}', '{"display_name":"Yuki Tanaka","handle":"yuki","craft":"Illustration"}', false, false, false, now(), now()),
