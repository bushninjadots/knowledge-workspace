          ...
          {projects.map((p) => {
            ...
            return (
              <Link
                ...
                to="/projects/$id"
                params={{ id: p.id }}
                className="group flex flex-col overflow-hidden rounded-xl border border-transparent bg-surface-elevated/30 transition hover:border-border/60 hover:bg-surface-elevated/50"
              >
