          ...
          {posts.map((post) => {
            ...
            return (
              <Link
                key={post.id}
                to="/community"
                className="group flex flex-col rounded-xl border border-transparent bg-surface-elevated/30 p-5 transition-lift hover:border-border/60 hover:bg-surface-elevated/50"
              >
