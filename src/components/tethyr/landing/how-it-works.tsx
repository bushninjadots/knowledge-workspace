    ...
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {steps.map((step) => (
          <div
            key={step.n}
            className="group relative overflow-hidden rounded-xl border border-transparent bg-surface-elevated/30 p-6 transition hover:border-border/60 hover:bg-surface-elevated/50"
          >
