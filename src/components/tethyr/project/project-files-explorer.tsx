            ...
            .map((f) => {
              ...
              return (
                <button
                  key={`${f.dir || ""}/${f.name}`}
                  onClick={() => onSelect(f)}
                  className={`flex w-full items-center gap-1.5 rounded-md px-2 py-1.5 text-left text-[13px] transition-lift ${
                    isSelected
      ...
      <div className="flex items-center gap-2 border-b border-border/40 px-3 py-2">
        ...
        {signedUrl && (
          <a
            ...
            rel="noreferrer"
            download={file.name}
            className="shrink-0 rounded-md p-1 text-muted-foreground transition-lift hover:bg-surface-elevated hover:text-foreground"
            title="Download"
          >
          ...
          <div className="flex h-full flex-col items-center justify-center gap-2 px-6 text-center">
            ...
            {signedUrl && (
              <a
                ...
                rel="noreferrer"
                download={file.name}
                className="mt-1 inline-flex items-center gap-1.5 rounded-full bg-primary px-3 py-1.5 text-xs font-medium text-background transition-fade hover:opacity-90"
              >
            ...
            <div className="flex items-center gap-2">
              <label className="relative">
                ...
                <input
                  ...
                  className="w-40 rounded-full border border-border/60 bg-background/50 py-1.5 pl-8 pr-7 text-xs text-foreground outline-none transition-lift focus:border-primary/50 focus:bg-background sm:w-48"
                />
                {query && (
                  <Button
                    type="button"
          ...
          >
            {files.length === 0 && query ? (
              ...
              <div
                ...
                className={`rounded-xl border-2 border-dashed px-6 py-10 text-center transition-lift ${
                      ...
                      >
                        ...
                        {isOwner && (
                          <button
                            ...
                            className="shrink-0 rounded-md p-1 text-muted-foreground opacity-0 transition-fade hover:bg-destructive/10 hover:text-destructive group-hover:opacity-100"
                            title="Remove"
                          >
