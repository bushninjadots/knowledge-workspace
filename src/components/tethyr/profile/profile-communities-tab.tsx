      ...
      <div className="space-y-6">
        <div className="animate-pulse rounded-2xl bg-surface p-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {[1, 2].map((item) => (
              <div key={item} className="h-24 rounded-2xl bg-surface-elevated" />
            ))}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {memberships.map((space) => (
              <Link
                ...
                className="group rounded-2xl border card-border bg-background/40 p-4 transition hover:-translate-y-0.5 hover:border-[var(--user-accent-border,var(--border-strong))]"
              >
      ...
      {pendingSpaces.length > 0 && (
        <div className="rounded-2xl border border-teaching/20 bg-teaching/5 p-5">
        ...
        <div className="rounded-2xl border card-border bg-surface p-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {discoverable.map((space) => (
              <div
                key={space.id}
                className="rounded-2xl border card-border bg-background/40 p-4 transition hover:border-[var(--user-accent-border,var(--border-strong))]"
              >
                <div className="flex items-start gap-3">
