        ...
        <div className="flex items-center gap-2">
          ...
          {onScheduleClick && (
            <button
              ...
              className="rounded-xl bg-[var(--user-accent,var(--trust))] px-3 py-1.5 text-xs font-semibold text-[var(--user-accent-foreground,var(--background))] transition-colors hover:bg-[var(--user-accent,var(--trust))]/90  active:scale-[0.98]"
            >
