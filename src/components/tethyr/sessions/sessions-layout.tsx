        ...
        <div className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-xl bg-[var(--user-accent,var(--trust))] px-4 py-2.5 text-sm font-semibold text-[var(--user-accent-foreground,var(--background))] transition-opacity transition-shadow transition-transform hover:opacity-90 active:scale-[0.98]"
            >
              + Schedule Session
            </button>
          </div>
