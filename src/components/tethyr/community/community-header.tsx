    ...
    <header className="mb-8">
      <div className="flex items-start justify-between gap-4">
        <div className="relative pl-4">
          ...
          <p className="text-[10px] font-semibold uppercase tracking-[0.15em] text-primary/60">Community</p>
        ...
        <div className="sticky top-12 z-20 -mx-2 mb-5 space-y-2 border-b border-border/40 bg-background/95 px-2 py-3">
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-0.5 scrollbar-none">
            <button
              ...
              className={`shrink-0 rounded-lg px-2.5 py-1 text-xs font-medium transition-colors duration-200 ${
                mySkillsOnly
