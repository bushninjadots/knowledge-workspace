...
export function sections({
  ...
  return [
    ...
    { key: "title", label: "Write a creator title", done: has(p?.creator_title), cta: cta() },
    ...
    { key: "category", label: "Pick a creator category", done: has(p?.category), cta: cta() },
    {
      key: "experience",
    ...
    { key: "teach", label: "Add your first teaching skill", done: teachCount > 0, cta: cta() },
    { key: "learn", label: "Add a skill you're learning", done: learnCount > 0, cta: cta() },
    {
      key: "tools",
